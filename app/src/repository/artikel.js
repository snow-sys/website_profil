...
exports.tambahArtikel = ({
  ...
  return connection
    .query(
      `
      insert into artikel(judul_artikel, isi_artikel, creator, slug_artikel, deskripsi, keyword)
      values($1, $2, $3, $4, $5, $6) returning *
      `,
      [judul_artikel, isi_artikel, creator, slug_artikel, deskripsi, keyword]
    )
    .then(({ rows }) => rows);
};

//function list artikel
exports.listArtikel = async ({ limit, from, slug_artikel, cari, uid }) => {
